...
<style>
    ...
    .card-minimalist {
        ...
        border-radius: 12px;
        box-shadow: 0 4px 16px rgba(0, 0, 0, 0.1); /* เงาอ่อนๆ ให้ลอยขึ้นมา */
    }
    .header-teal {
        ...
        <div class="col-lg-9">
            ...
            <div class="card card-minimalist">
                <div class="header-teal">
                    <h1 class="h4 mb-0"><i class="bi bi-person-workspace me-2"></i> JOB APPLICATION // OPEN POSITIONS</h1>
                    <p class="mb-0 fs-6">ใบสมัครงาน 66010914047 ไชยวัฒน์ เห</p>
                </div>
...
<script>
    // Script สำหรับ Bootstrap Validation (ตรวจสอบความถูกต้องของฟอร์ม)
    (function () {
      'use strict'
